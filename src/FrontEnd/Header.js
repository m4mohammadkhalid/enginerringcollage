  ...
  return (
    <>
      <Helmet>
        ...
        <div style={{backgroundImage: 'url("image/white_wall.png")', backgroundRepeat:'no-repeat',backgroundPosition: 'center',backgroundSize: 'cover'}} className="site-header" >
    <div style={{padding:'0px 10px 0px 20px'}}>
      <div className="row">
        <div className="col-lg-2 col-md-4 khalidmedia">
          <div className="site-brand">
            <img className="logofix" style={{width:'150px',height:'130px', paddingTop:'10px' }} src="image/logo.png"  alt="khalid" />
            <div className="navbar-brandd">
                <h1>SKITM Engineering College</h1>
            </div>
          </div>
        </div>
        <div style={{paddingTop:"40px"}} className="col-lg-5 col-md-4 navbar-branddd">
                ...
                <h4 style={{color:'#1E2264'}}>SKITM Engineering College</h4>
        ...
        <div style={{paddingTop:"30px",paddingLeft:'60px'}} className="navbar-branddd col-lg-5 col-md-4">
              ...
              <img style={{width:'160px',height:'60px',marginRight:'60px' }} src="image/global-presence.png" alt="Developer Khalid" />
              <img style={{width:'140px',height:'60px' }} src="image/login-btn.png" alt="Global Presence" />
              </div>
				</div>
      </div>
